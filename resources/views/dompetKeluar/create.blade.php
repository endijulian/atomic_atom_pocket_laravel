                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li><a href="{{ route('dompetmasuk.index') }}">Dompet Keluar</a></li>
                                        <li class="active">Create Dompet Keluar</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Tambah Dompet Keluar</strong>
                    <a href="{{ route('dompetkeluar.index') }}" class="float-right btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kelola Dompet Keluar</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('dompetkeluar.store') }}" method="post" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="card-body col-lg-3">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="kode" name="kode" type="text" class="form-control" readonly placeholder="WOUTxxxxx" aria-required="true" aria-invalid="false" value="{{ old('kode') }}">
