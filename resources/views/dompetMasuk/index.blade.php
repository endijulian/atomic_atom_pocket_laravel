                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Dompet Masuk</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-12">
        <div class="card h-75">
            <div class="col-md-12 mt-3">
                <a href="{{ route('dompetmasuk.create') }}" class="float-right btn btn-primary">Buat Baru</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Dompet Masuk</strong>
                </div>
                <div class="card-body">
