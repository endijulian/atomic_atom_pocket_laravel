        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Dompet</strong>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="input-group-btn">
                                            <div class="btn-group">
                                                ...
                                                <div tabindex="-1" aria-hidden="true" role="menu" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                    ...
                                                    <a href="{{ route('dompet.show',$dompet->id) }}" class="dropdown-item"><i class="fa fa-search mr-2"></i> Detail</a>
                                                    <a href="{{ route('dompet.edit', $dompet->id) }}" class="dropdown-item"><i class="fa fa-pencil mr-2"></i> Ubah</a>
                                                    @if ($dompet->status_id == 1)
                                                        <form action="{{ route('dompet.inActive', $dompet->id) }}" method="POST">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form action="{{ route('dompet.Active', $dompet->id) }}" method="POST">
                                                            @csrf
